...
# network.collect_params().initialize(mx.init.Xavier(rnd_type='uniform', factor_type='avg', magnitude=3))
network.collect_params().initialize(mx.init.Orthogonal(scale=1.414, rand_type='uniform'))
...
plt.plot(network_1_train_loss, c="blue", label="Normal Initialization")
plt.plot(network_1_train_loss, c="red", label = "Xavier Initialization")
plt.plot(network_1_train_loss, c="green", label = "Orthogonal Initialization")
plt.legend()
