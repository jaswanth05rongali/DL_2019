...
test_accuracy,test_loss = accuracy(test_data,network)
print("Epochs: %s. Loss: %s, Train_acc: %s,Validation_acc: %s,test_accuracy:%s,Average Epoch duration(in secs): %s" %
      (i+1, cumulative_loss/num_instances, train_accuracy,val_accuracy,test_accuracy,avg_epochs_dur))

plt.figure("Image")
plt.title("Network_1 Loss vs Epoch")
...
network.save_parameters("NN1.params")